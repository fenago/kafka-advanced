...
Welcome to the session 3 lab. The work for this lab is done in `~/kafka-advanced/Lab03-2`.
...
#### ~/kafka-advanced/Lab03-2/src/main/java/com/fenago/kafka/KafkaConsumerExample.java
...
#### ~/kafka-advanced/Lab03-2/solution/src/main/resources/logback.xml
```xml
<configuration>
