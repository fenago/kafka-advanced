...
#### ~/kafka-advanced/labs/Lab13-1/bin/create-topics.sh
...
```sh
$ cd ~/kafka-advanced/labs/Lab13-1/bin          
$ ./create-topics.sh                        
...
#### ~/kafka-advanced/labs/Lab13-1/bin/start-producer-console-input.sh
...
## ***ACTION*** - EDIT `~/kafka-advanced/labs/Lab13-1/bin/start-consumer-console-output.sh`, follow instructions in file.
